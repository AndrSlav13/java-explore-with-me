...
create table if not exists public.comments (
                                               ...
                                               primary key (id),
                                               constraint FKa3cy75dq5946vf55u5wimoxi7
                                                   foreign key (commented_id)
                                                       references public.events on delete cascade,

                                               constraint FK4jh8ht3vtgr6ibapo4yxe81gr
                                                   foreign key (commenter_id)
                                                       references public.users,

                                               constraint FK7h839m3lkvhbyv3bcdv7sm4fj
                                                   foreign key (parent_comment_id)
                                                       references public.comments on delete cascade
);
...
create table if not exists public.comment_details (
                                        ...
                                        constraint FKajaan4vhpc9j3qrj8v0v0d5il
...
create table if not exists event_compilation (
                                   ...
                                   constraint FKcjjymedxn01uxg7g6tk0a4xwg
                                       ...
                                       references public.compilations on delete cascade,
